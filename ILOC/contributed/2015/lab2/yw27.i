...
// Example usage: ./sim -i 1024 1028 1 2 < submitted.i
...
// Because the last use of r2 is the command add r2,r3 => r4 (in line 31)
...
// Because the last use of r3 is the command add r3,r4 => r4 (in line 33)
